                            ...
                            <li class="mega-position">
                                ...
                                <div class="mega-menu mega-3-colm">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="shop-v2-sub-category.php" class="u-c-brand">Shop</a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="shop-v1-root-category.php" class="u-c-brand">Shop Ver 1 Root Category</a>
                                        </li>
                                        <li>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12">
                    ...
                    <div class="fetch-categories">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Hoodies
                                    <span class="total-fetch-items">(1)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Suits
                                    <span class="total-fetch-items">(1)</span>
                                </a>
                            </li>
                            <li>
                        ...
                        <!-- Level-2 -->
                        <h3 class="fetch-mark-category">
                            <a href="shop-v2-sub-category.php">Outwear
                        ...
                        <ul>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Jackets
                                    <span class="total-fetch-items">(3)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Trench
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Parkas
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Sweaters
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Watches
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v2-sub-category.php">Ties
                                    <span class="total-fetch-items">(1)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Scarves
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Belts
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Shoes
                                    <span class="total-fetch-items">(1)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Jeans
                                    <span class="total-fetch-items">(1)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Shorts
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <!-- Level-2 -->
                        <h3 class="fetch-mark-category">
                            <a href="shop-v2-sub-category.php">Underwear
                                <span class="total-fetch-items">(0)</span>
                            </a>
                        </h3>
                        <!-- Level-2 /- -->
                        ...
                        <ul>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Boxers
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Briefs
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Robes
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Socks
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <!-- Level-2 -->
                        <h3 class="fetch-mark-category">
                            <a href="shop-v2-sub-category.php">Sunglasses
                                <span class="total-fetch-items">(2)</span>
                            </a>
                        </h3>
                        <!-- Level-2 /- -->
                        ...
                        <ul>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Pilot
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Wayfarer
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Square
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v3-sub-sub-category.php">Round
                                    <span class="total-fetch-items">(2)</span>
                                </a>
                            </li>
                        </ul>
