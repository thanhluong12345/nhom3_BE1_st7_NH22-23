                            ...
                            <li class="mega-position">
                                ...
                                <div class="mega-menu mega-3-colm">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="blog-detail.php" class="u-c-brand">Blog Details</a>
                                        </li>
                                    </ul>
                                    <ul>
        ...
        <div class="container">
            <div class="page-intro">
                ...
                <ul class="bread-crumb">
                    ...
                    <li class="is-marked">
                        <a href="blog-detail.php">Post Name</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="blog-detail-wrapper">
            ...
            <div class="previous-next-wrapper u-s-m-b-25">
                ...
                <div class="next-container">
                    <a href="blog-detail.php">Next Post
                    ...
                    <li>
                        <div class="comment-body">
                            <div class="comment-author-image">
                                <img src="public/images/blog/avatar.jpg" alt="avatar image">
                            </div>
