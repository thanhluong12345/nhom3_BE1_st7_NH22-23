<?php
    ...
    if( $_GET["id"] ) {
        ...
        $product = $mo_product->getProductById($id);
        
        $manu_id = $product["manu_id"];
        $product_by_manuid = $mo_product->getProductByMenuid($manu_id);

        // var_dump($product_by_manuid);
        // exit;
    }
                            ...
                            <li class="mega-position">
                                ...
                                <div class="mega-menu mega-3-colm">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="single-product.php" class="u-c-brand">Single Product Fullwidth</a>
                                        </li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <!-- Product-zoom-area -->
                    <div class="zoom-area">
                        <img id="zoom-pro" class="img-fluid" src="public/images/product/<?= $product['image']?>" >
                        <div id="gallery" class="u-s-m-t-10">
                            <a class="active" data-image="public/images/product/<?= $product['image']?>" >
                                <img src="public/images/product/<?= $product['image']?>" alt="Product">
                            </a> 
                        </div>
                    </div>
                    <!-- Product-zoom-area /- -->
                    ...
                    <div class="all-information-wrapper">
                        <div class="section-1-title-breadcrumb-rating">
                            ...
                            <ul class="bread-crumb">
                                ...
                                <li class="has-separator">
                                    <a href="shop-v1-root-category.php">MobilePhone</a>
                                </li>
                                <li class="has-separator">
                                    <a href="shop-v2-sub-category.php">Tops</a>
                                </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade active show" id="description">
                                <div class="description-whole-container">
                                    ...
                                    <img class="desc-img img-fluid u-s-m-b-26" src="public/images/product/<?= $product['image']?>" alt="Product">
                ...
                <section class="section-maker">
                    ...
                    <div class="container">
                        ...
                        <div class="slider-fouc">
                            ...
                            <?php
                            foreach($product_by_manuid as $value):
                                ?>
                                <div class="item">
                                    <div class="image-container">
                                        <a class="item-img-wrapper-link" href="single-product.php?id=<?=$value['manu_id']?>">
                                            <img class="img-fluid" src="public/images/product/<?=$value['image']?>" alt="Product">
                                        </a>
                                    ...
                                    <div class="item-content">
                                        <div class="what-product-is">
                                            <ul class="bread-crumb">
                                                ...
                                                <li>
                                                    <a href="shop-v3-sub-sub-category.php"><?=$value['name']?></a>
                                                </li>
                                            </ul>
                                            <h6 class="item-title">
                                                <a href="single-product.php"> <?= $value["name"] ?></a>
                                            </h6>
